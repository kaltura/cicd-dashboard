...
const api = {
    ...
    env: (env, res) => {
        ...
        var windowsRepos = [
            ...
            {from_image: `${env.env.src}-filebeat:latest`, to_image: `${env.env.tag}-phoenix:latest`},
            {from_image: `${env.env.src}-filebeat:latest`, to_image: `${env.env.tag}-ingest:latest`},
            {from_image: `${env.env.src}-filebeat:latest`, to_image: `${env.env.tag}-web-services:latest`},
            {from_image: `${env.env.src}-filebeat:latest`, to_image: `${env.env.tag}-tvp-api:latest`},
        ];
